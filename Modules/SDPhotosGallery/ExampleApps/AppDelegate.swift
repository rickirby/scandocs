...
//  ExampleApps
//
//  Created by Ricki Bin Yamin on 08/10/23.
//
...
extension AppDelegate: ICrossModuleNavigation {
    ...
    func navigateToEditScan(image: UIImage, rectanglePoint: Any?, isRotateImage: Bool, documentGroup: Any?, currentDocument: Any?) {
        print(">>> Should navigate to Edit Scan with rectanglePoint: \(String(describing: rectanglePoint)), documentGroup: \(String(describing: documentGroup)), document: \(String(describing: currentDocument))")
    }
}
